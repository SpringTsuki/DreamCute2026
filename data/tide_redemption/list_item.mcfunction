...
# 实验样本（怪物掉落）
# 用于基础物品制作兑换
give @p minecraft:rotten_flesh[item_name='{"translate":"game.item.resource.material"}',lore=['{"translate":"game.item.resource.material_lore1"}','{"text":""}','{"translate":"game.item.resource.material_lore2"}','{"translate":"game.item.resource.material_lore3"}','{"translate":"game.item.resource.material_lore4"}']]

# 实验材料块
give @p minecraft:cobblestone[item_name='{"translate":"game.item.resource.cobblestone"}',lore=['{"translate":"game.item.resource.cobblestone_lore1"}']]

# 实验用铁
give @p minecraft:iron_ingot[item_name='{"translate":"game.item.resource.iron_ingot"}',lore=['{"translate":"game.item.resource.iron_ingot_lore1"}']]

# 实验用钻石
give @p minecraft:diamond[item_name='{"translate":"game.item.resource.diamond"}',lore=['{"translate":"game.item.resource.diamond_lore1"}'],rarity="rare"]

# 合金加工模具
give @p minecraft:netherite_upgrade_smithing_template[item_name='{"translate":"game.item.resource.netherite_module"}',lore=['{"translate":"game.item.resource.netherite_module_lore1"}'],rarity="epic"]

# 合金
give @p minecraft:netherite_ingot[item_name='{"translate":"game.item.resource.netherite_ingot"}',lore=['{"translate":"game.item.resource.netherite_ingot_lore1"}'],rarity="epic"]

# 牛肉
give @p minecraft:cooked_beef[item_name='{"translate":"game.item.resource.food_beef"}',lore=['{"translate":"game.item.resource.food_beef_lore1"}']]
