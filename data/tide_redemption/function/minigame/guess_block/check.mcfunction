...
execute if data block 898 88 2010 {Items:[{Slot:0b,id:"minecraft:gold_block"}]} if block 895 86 2010 minecraft:coal_block run scoreboard players add #user minigame_guessblock_count 1
execute if data block 898 88 2010 {Items:[{Slot:0b,id:"minecraft:netherite_block"}]} if block 895 86 2010 minecraft:gold_block run scoreboard players add #user minigame_guessblock_count 1
...
execute if data block 898 88 2010 {Items:[{Slot:1b,id:"minecraft:gold_block"}]} if block 895 86 2011 minecraft:coal_block run scoreboard players add #user minigame_guessblock_count 1
execute if data block 898 88 2010 {Items:[{Slot:1b,id:"minecraft:netherite_block"}]} if block 895 86 2011 minecraft:gold_block run scoreboard players add #user minigame_guessblock_count 1
...
execute if data block 898 88 2010 {Items:[{Slot:2b,id:"minecraft:gold_block"}]} if block 895 86 2012 minecraft:coal_block run scoreboard players add #user minigame_guessblock_count 1
execute if data block 898 88 2010 {Items:[{Slot:2b,id:"minecraft:netherite_block"}]} if block 895 86 2012 minecraft:gold_block run scoreboard players add #user minigame_guessblock_count 1
...
execute if data block 898 88 2010 {Items:[{Slot:3b,id:"minecraft:gold_block"}]} if block 895 86 2013 minecraft:coal_block run scoreboard players add #user minigame_guessblock_count 1
execute if data block 898 88 2010 {Items:[{Slot:3b,id:"minecraft:netherite_block"}]} if block 895 86 2013 minecraft:gold_block run scoreboard players add #user minigame_guessblock_count 1
