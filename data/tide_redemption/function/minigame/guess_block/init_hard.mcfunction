...
# 此处生成答案
loot insert 898 88 2010 loot tide_redemption:minigame/minigame_guessblock_hard
loot insert 898 88 2010 loot tide_redemption:minigame/minigame_guessblock_hard
loot insert 898 88 2010 loot tide_redemption:minigame/minigame_guessblock_hard
loot insert 898 88 2010 loot tide_redemption:minigame/minigame_guessblock_hard

# 计分板保存难度
scoreboard players set #user minigame_guessblock_difficulty 2

# 告知玩家初始化完成
execute as @a[x=896,y=85,z=2004,dx=-7,dy=3,dz=11] at @s run function tide_redemption:bgm/minigame/guess_hard_start
