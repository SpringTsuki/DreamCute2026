...
execute as @e[tag=fast_memory_forget_near.armor_stand] at @s if score #user fast_memory_forget_near matches 80 run function tide_redemption:boss_extra/skill/fast_memory_forget_near/image_red
