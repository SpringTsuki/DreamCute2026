...
execute store result score #player_number memory_torrent_song_tower_E run execute as @e[tag=torrent_song_E] at @s if entity @a[distance=..2]
execute store result score #player_number memory_torrent_song_tower_F run execute as @e[tag=torrent_song_F] at @s if entity @a[distance=..2]
execute store result score #player_number memory_torrent_song_tower_G run execute as @e[tag=torrent_song_G] at @s if entity @a[distance=..2]
execute store result score #player_number memory_torrent_song_tower_H run execute as @e[tag=torrent_song_H] at @s if entity @a[distance=..2]
...
execute as @e[tag=torrent_song_E] at @s if score #player_number memory_torrent_song_tower_E matches 1.. run effect give @a[distance=..2] minecraft:instant_damage 1 0
execute as @e[tag=torrent_song_F] at @s if score #player_number memory_torrent_song_tower_F matches 1.. run effect give @a[distance=..2] minecraft:instant_damage 1 0
execute as @e[tag=torrent_song_G] at @s if score #player_number memory_torrent_song_tower_G matches 1.. run effect give @a[distance=..2] minecraft:instant_damage 1 0
execute as @e[tag=torrent_song_H] at @s if score #player_number memory_torrent_song_tower_H matches 1.. run effect give @a[distance=..2] minecraft:instant_damage 1 0
...
execute as @e[tag=torrent_song_E] at @s unless score #player_number memory_torrent_song_tower_E matches 1.. run effect give @a[distance=..30] minecraft:instant_damage 1 5
execute as @e[tag=torrent_song_F] at @s unless score #player_number memory_torrent_song_tower_F matches 1.. run effect give @a[distance=..30] minecraft:instant_damage 1 5
execute as @e[tag=torrent_song_G] at @s unless score #player_number memory_torrent_song_tower_G matches 1.. run effect give @a[distance=..30] minecraft:instant_damage 1 5
execute as @e[tag=torrent_song_H] at @s unless score #player_number memory_torrent_song_tower_H matches 1.. run effect give @a[distance=..30] minecraft:instant_damage 1 5
