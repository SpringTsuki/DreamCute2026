scoreboard players add #user delay_memory_forget_near 1
execute store result bossbar minecraft:delay_memory_forget_near value run scoreboard players get #user delay_memory_forget_near
...
execute if score #user delay_memory_forget_near matches 120 run function tide_redemption:boss_extra/skill/delay_memory_forget_near/end