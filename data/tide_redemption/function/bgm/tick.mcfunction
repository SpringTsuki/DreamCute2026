function tide_redemption:bgm/jukebox/tick

# 如果游戏结束，则不检测基地音乐
execute if score #user bgm_jukebox matches 1 run return 0
...
execute as @a at @s if score @s bgm_leave_base matches 1 run function tide_redemption:bgm/game_base_leave/check