...
# 触发后续对话
execute as @a at @s if score @s tided_npc_castorvow_chat matches 1 run tellraw @s {"translate":"game.npc.name.castorvow.welcome1"}
...
# 触发暂离对话
execute as @e[tag=tided_npc_castorvow_armor] at @s as @a[distance=3..] if score @s tided_npc_castorvow_chat matches 1.. run tellraw @s {"translate":"game.npc.name.castorvow.bye1"}
