...
execute if score @s tided_monster_count matches ..9 run summon minecraft:zombie ~ ~ ~ {Tags: ["tided_monster","tided_monster.east","tided_monster.zombie"],CustomName:'{"translate": "game.monster.east.a.zombie"}', DeathLootTable: "tide_redemption:monster/east/zombie_a", ArmorItems: [{},{},{},{}], attributes:[{id:"generic.max_health",base:15}], HandDropChances: [0f,0f], ArmorDropChances: [0f,0f,0f,0f], CustomNameVisible: true, CanPickUpLoot: false}
