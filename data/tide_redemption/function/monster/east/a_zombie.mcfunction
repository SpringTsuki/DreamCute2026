...
execute if score @s tided_monster_count matches ..9 run summon minecraft:zombie ~ ~ ~ {Tags: ["tided_monster","tided_monster.east","tided_monster.a_zombie"],CustomName:'{"translate": "game.monster.a.zombie"}', DeathLootTable: "tide_redemption:monster/east/a_zombie", ArmorItems: [{},{},{},{}], attributes:[{id:"generic.max_health",base:15}], HandDropChances: [0f,0f], ArmorDropChances: [0f,0f,0f,0f], CustomNameVisible: true, CanPickUpLoot: false}
